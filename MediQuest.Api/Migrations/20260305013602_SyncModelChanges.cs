        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Claims_Medications_MedicationId",
                        column: x => x.MedicationId,
                        principalTable: "Medications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Claims_Parties_PartyId",
                        column: x => x.PartyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserUnlocks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserUnlocks_UnlockDefinitions_UnlockDefinitionId",
                        column: x => x.UnlockDefinitionId,
                        principalTable: "UnlockDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_MedicationId",
                table: "Claims",
                column: "MedicationId");

            migrationBuilder.CreateIndex(
                name: "IX_Claims_PartyId",
                table: "Claims",
                column: "PartyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserUnlocks_UnlockDefinitionId",
                table: "UserUnlocks",
                column: "UnlockDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserUnlocks_UserId_UnlockDefinitionId",
                table: "UserUnlocks",
                columns: new[] { "UserId", "UnlockDefinitionId" },
                unique: true);
        }
